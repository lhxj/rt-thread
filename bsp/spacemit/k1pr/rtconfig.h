...
/* RT-Thread Kernel - Minimal myk1 BSP Configuration */
...
/* DFS: Minimal device virtual file system (required by serial driver) */
#define RT_USING_DFS
...
/* DMA Support (needed for Serial DMA) */
#define RT_USING_DMA
#define RT_DMA_MMP_PDMA
#define RT_DMA_MMP_PDMA_SUPPORT_64BIT

/* I2C Support (for PMIC over I2C) */
#define RT_USING_I2C
...
/* Regulator & Syscon (required by PM domain with DM) */
